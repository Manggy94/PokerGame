...
function ActivePlayer({player}){
    return <tr key={player.name} className="table-primary">
...
const players = [
    {name: "Toto", stack: 72000, position: "HJ", odds:2, equity: 1/3, active: true, toCall: 0, combo: "None", folded: false},
    {name: "Tata", stack: 15000, position: "CO", odds:3, equity: 1/2, active: false, toCall: 0, combo: "AsAd", folded: false},
    {name: "Tété", stack: 215800, position: "BTN", odds:2, equity: 1/4, active: false, toCall: 3000, combo: "AhJh", folded: false},
    {name: "Titi", stack: 33000, position: "SB", odds:4, equity: 1/4, active: false, toCall: 3000, combo: "Th9h", folded: true}
]

let src="toto.fr"
console.log(src)
setInterval(RenderPlayers(players), 1000)
